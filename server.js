// server.js COMPLETO, FINAL Y OPTIMIZADO
...
// Render inyecta la URL de conexión aquí
...
// ====================================================
// 3. FUNCIONES DE BASE DE DATOS (CRUCIAL: EVITA ReferenceError)
//    Todas las funciones deben estar aquí, antes de los Endpoints
// ====================================================
...
async function getHistory() {
    ...
    try {
        const result = await dbClient.query(query);
        // Invertimos los datos para que el más antiguo quede primero
...
app.post('/data', async (req, res) => {
    // Llama a saveData, que ahora está definida (Error ReferenceError corregido)
    const data = req.body;
